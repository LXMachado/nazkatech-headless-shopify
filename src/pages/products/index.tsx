        ...
        <div className="container-custom">
          {loading ? (
            ...
            <button 
              ...
              className="w-full sm:w-auto bg-eco-green-500 hover:bg-eco-green-400 text-eco-dark-900 rounded-full px-4 py-2 transition-colors inline-flex items-center justify-center gap-2 whitespace-nowrap"
            >
